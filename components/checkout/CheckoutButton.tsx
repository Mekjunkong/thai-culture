...
export default function CheckoutButton({ children, className }: CheckoutButtonProps) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={className ?? 'inline-flex min-h-12 items-center justify-center rounded-none bg-honey px-6 py-3 font-bold text-tamarind transition duration-200 ease-out hover:-translate-y-0.5 hover:opacity-85 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-surface'}
    >
